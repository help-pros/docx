...
If UCase(signMsg)=UCase(merchantSignMsg) then
	...
	Select Case payResult
		  ...
		  case "10"
			...
			rtnOk=1
			rtnUrl="http://219.233.173.50:8804/yixiao/show.asp?msg=success!"
			
		  
		 Case else

			rtnOk=1
			rtnUrl="http://219.233.173.50:8804/yixiao/show.asp?msg=false!"
	...
	rtnOk=1
	rtnUrl="http://219.233.173.50:8804/yixiao/show.asp?msg=error!"
